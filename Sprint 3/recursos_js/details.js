...
function pintarDetails(i){
  contentDetails.innerHTML = `
    <div class="col-10 d-flex flex-md-nowrap flex-wrap bg-success rounded">
                    <div class="container">
                        <img src="${data.events[i].image}" alt="details" class="imgDetails">
                      </div>
                    <div class="container d-flex flex-column align-items-start bg-success rounded">
                        <h3 class="d-flex align-self-center">${data.events[i].name}</h3>
